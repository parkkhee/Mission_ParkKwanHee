...
public class LikeablePersonServiceTests {
    ...
    void t009() throws Exception {
        ...
        List<LikeablePerson> likeablePeople = likeablePersonService
                .filterByGenderAndAttractiveTypeCode(instaMember4, "","0","2");
    ...
    void t010() throws Exception {
        ...
        InstaMember instaMember4 = instaMemberRepository.findByUsername("insta_user4").get();
        List<LikeablePerson> likeablePeople = likeablePersonService
                .filterByGenderAndAttractiveTypeCode(instaMember4, "","0","1");
    ...
    void t011() throws Exception {
        ...
        InstaMember instaMember4 = instaMemberRepository.findByUsername("insta_user4").get();
        List<LikeablePerson> likeablePeople = likeablePersonService
                .filterByGenderAndAttractiveTypeCode(instaMember4, "","0","3");
    ...
    void t012() throws Exception {
        ...
        InstaMember instaMember4 = instaMemberRepository.findByUsername("insta_user4").get();
        List<LikeablePerson> likeablePeople = likeablePersonService
                .filterByGenderAndAttractiveTypeCode(instaMember4, "","0","4");
    ...
    void t013() throws Exception {
        ...
        InstaMember instaMember4 = instaMemberRepository.findByUsername("insta_user4").get();
        List<LikeablePerson> likeablePeople = likeablePersonService
                .filterByGenderAndAttractiveTypeCode(instaMember4, "","0","5");
