...
public class LikeablePersonRepositoryImpl implements LikeablePersonRepositoryCustom {
    ...
    @Override
    public List<LikeablePerson> findAllByCreateDate(BooleanBuilder builder, OrderSpecifier<?> orderSpecifier){
    ...
    @Override
    public List<LikeablePerson> findQslByToInstaMemberAndGenderAndAttractiveTypeCode
            (InstaMember instaMember, String gender, int attractiveTypeCode, int sortCode){
